...
const selectTriggerVariants = cva("", {
  variants: {
    size: {
      xs: "h-8 gap-1 px-2 py-1",
      sm: "h-9 gap-1.5 px-2.5 py-1.5",
      default: "h-10 gap-2 px-3 py-2",
      lg: "h-11 gap-2 px-3.5 py-2",
    },
  },
  defaultVariants: {
    size: "default",
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "border-input dark:bg-input/30 dark:active:bg-input/50 bg-background flex flex-row items-center justify-between rounded-md border shadow-sm shadow-black/5",
      ...
      hitSlop={hitSlop ?? selectTriggerHitSlop[resolvedSize]}
      {...props}
    >
      <>{children}</>
